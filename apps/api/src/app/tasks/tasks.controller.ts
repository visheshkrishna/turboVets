...
export class TasksController {
  ...
  async findAll(
    ...
    const result = await this.tasksService.findAll(queryDto, user.role, accessibleOrgIds, user.userId);
  ...
  async findOne(
    ...
    const accessibleOrgIds = await this.organizationsService.getAccessibleOrganizations(user.organizationId);
    return this.tasksService.findOne(id, user.role, user.userId, accessibleOrgIds);
  }
  ...
  async remove(
    ...
    const accessibleOrgIds = await this.organizationsService.getAccessibleOrganizations(user.organizationId);
    await this.tasksService.remove(id, user.role, user.userId, accessibleOrgIds);
